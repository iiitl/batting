    ...
    <div className="w-full h-screen flex justify-center items-center ">
      <div className="flex flex-col z-10   p-5  px-7 items-start  w-full  h-full shadow-2xl">
        ...
        <div className="flex flex-col my-3">
          ...
          <input
            type="text"
            className="border border-gray-300  w-64 h-10 rounded-lg outline-none px-2 py-2 font-medium "
            ref={name}
          />
          {nameErr && (
        ...
        <div className="flex flex-col my-2">
          ...
          <input
            ...
            className=" w-64 h-10 rounded-lg outline-none px-2 py-2 font-medium"
            ref={pass}
          />
          {passEmp && (
            <small className="text-red-600 text-[1rem] ">
