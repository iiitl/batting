...
const DetailsCard = ({
  ...
  const normal =
    "w-full tbl flex items-start px-5 py-3 my-3  flex-col justify-evenly";
  const lose =
    "w-full lose flex items-start px-5 py-3 my-3 flex-col justify-evenly";
  const win =
    "w-full win flex items-start px-5 py-3 my-3  flex-col justify-evenly";
  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col max-h-[12rem]  mx-3  my-2 text-black">
      ...
      {status == "pending" && (
        <div className="flex justify-evenly h-full mx-3 ">
          <button
            className=" text-3xl  mx-4 text-green-600 active:scale-105 duration-200 "
            onClick={() => {
          ...
          <button
            className=" text-3xl text-red-600 active:scale-105 duration-200 "
            onClick={() => {
